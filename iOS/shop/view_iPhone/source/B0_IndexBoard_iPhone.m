...
//    self.parentViewController.modalPresentationCapturesStatusBarAppearance =NO;
//    self.parentViewController.navigationController.navigationBar.translucent =NO;
